-- ============================================================
-- WACRM - SETUP COMPLETO & MIGRAÇÃO CONSOLIDADA
-- ============================================================
-- Este script faz a limpeza segura das tabelas obsoletas/incompatíveis
-- do projeto anterior e aplica todas as 42 migrações oficiais do WACRM.
--
-- Preserva com segurança os usuários autenticados (auth.users).
-- ============================================================

-- 1. DROPAR VIEWS, TABELAS E RPCS DO SCHEMA ANTERIOR (SE EXISTIREM)
DROP VIEW IF EXISTS public.vw_ads_roi CASCADE;
...
DROP TABLE IF EXISTS public.ads_metrics_daily CASCADE;
...
DROP FUNCTION IF EXISTS public.has_role_in(uuid, text) CASCADE;
DROP FUNCTION IF EXISTS public.is_member_of(uuid) CASCADE;

-- 2. HABILITAR EXTENSÕES ESSENCIAIS
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
CREATE EXTENSION IF NOT EXISTS "vector";

-- ============================================================
-- 3. APLICAÇÃO DAS 42 MIGRAÇÕES DO WACRM EM ORDEM
-- ============================================================


-- ============================================================
-- MIGRAÇÃO 1/42: 001_initial_schema.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 2/42: 002_pipelines_enhancements.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 3/42: 003_broadcast_recipient_wamid.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 4/42: 004_contact_delete_set_null.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 5/42: 005_broadcast_counts_incremental.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 6/42: 006_automations.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 7/42: 007_automations_increment_counter.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 8/42: 008_profile_avatars_storage.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 9/42: 009_message_actions.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 11/42: 011_profile_beta_features.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 12/42: 012_flows_increment_counter.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 13/42: 013_whatsapp_config_phone_number_id_unique.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 14/42: 014_message_templates_meta_integration.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 15/42: 015_whatsapp_config_registration.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 16/42: 016_flow_media.sql
-- ============================================================
-- ============================================================
-- 016_flow_media.sql
--
...
-- ============================================================
-- MIGRAÇÃO 17/42: 017_account_sharing.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 18/42: 018_account_member_rpcs.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 19/42: 019_invitation_rpcs.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 20/42: 020_account_sharing_followups.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 21/42: 021_account_default_currency.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 22/42: 022_contact_phone_dedup.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 23/42: 023_chat_media.sql
-- ============================================================
-- ============================================================
-- 023_chat_media.sql
--
...
-- ============================================================
-- MIGRAÇÃO 24/42: 024_member_presence.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 25/42: 025_filter_contacts_by_tags.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 26/42: 026_api_keys.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 27/42: 027_notifications.sql
-- ============================================================
-- ============================================================
-- NOTIFICATIONS
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 28/42: 028_webhook_endpoints.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 29/42: 029_ai_reply.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 30/42: 030_ai_knowledge.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 31/42: 031_ai_reply_slot_grant.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 32/42: 032_fix_ai_knowledge_membership.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 33/42: 033_ai_reply_polish.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 34/42: 034_fix_profiles_update_rls.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 35/42: 035_interactive_messages.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 36/42: 036_conversation_contact_dedup.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 37/42: 037_webhook_broadcast_reliability.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 38/42: 038_broadcast_resume.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 39/42: 039_inbound_media_mirror.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 40/42: 040_contact_business_scoped_user_id.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 41/42: 041_fix_broadcast_contact_id_ambiguity.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- MIGRAÇÃO 42/42: 042_message_failure_reason.sql
-- ============================================================
-- ============================================================
...
-- 3. Inserir Estágios do Pipeline
INSERT INTO public.pipeline_stages (id, pipeline_id, name, "order", color, created_at)
VALUES
  ('b1000000-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d', 'Novos Leads', 0, '#3B82F6', NOW()),
  ('b1000000-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d', 'Agendado', 1, '#C5A880', NOW()),
  ('b1000000-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d', 'Atendimento Concluído', 2, '#10B981', NOW()),
  ('b1000000-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d', 'Retorno (15-30 dias)', 3, '#F59E0B', NOW()),
  ('b1000000-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d', 'Cliente VIP / Fidelizado', 4, '#8B5CF6', NOW())
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  "order" = EXCLUDED."order",
  color = EXCLUDED.color;

-- 4. Inserir Modelos de Mensagem WhatsApp para a Barbearia
...
-- 5. Inserir Base de Conhecimento da IA (AI Knowledge) para o Atendente Virtual
