...
export default async function AdminDashboardPage() {
  ...
  try {
    // Fetch all appointments for today with connection retry
    ...
    tenant = await withPrismaRetry(() => prisma.tenant.findFirst());
    views = tenant?.views || 0;
  } catch (error) {
    console.warn('Dashboard SSR database warning (loading with fallback data):', error);
  }
